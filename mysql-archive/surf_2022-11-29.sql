...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bfinance` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `company`(`id`,`name`,`comment`,`create_time`) values 
(1597614344248561666,'zzzz马231','asad',NULL),
(1597614366977495041,'zzzz马231','asad',NULL),
(1597614367581474818,'zzzz马231','asad',NULL),
(1597614368307089410,'zzzz马231','asad',NULL),
(1597614369032704002,'zzzz马231','asad',NULL),
(1597614476880842754,'zzzz马231aaaaa','asad',NULL),
(1597614498519257089,'zzzz马231aaaaa','asad',NULL),
(1597614508744970242,'zzzz马231aaaaba','asad',NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='风险报告';
...
CREATE TABLE `voucher_item` (
  `id` bigint(20) NOT NULL COMMENT '凭证单号',
