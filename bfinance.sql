...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='风险报告';

/*Data for the table `rs_risk_report` */

insert  into `rs_risk_report`(`id`,`risk_id`,`analysis`,`measure`,`create_time`) values
                                                                                     (1,NULL,'sd','asd','2022-10-04 06:47:34'),
                                                                                     (2,NULL,'zx','as','2022-10-15 06:47:56');
...
insert  into `ums_admin`(`id`,`username`,`password`,`icon`,`email`,`nick_name`,`note`,`create_time`,`login_time`,`status`,`dept_id`,`company_id`,`job_id`) values
                                                                                                                                                               (1,'test','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','asdasd@asasdasd.com','测试账号','123123123','2018-09-29 13:55:30','2018-09-29 13:55:39',1,1,1,NULL),
                                                                                                                                                               (3,'admin','$2a$10$.E1FokumK5GIXWgKlg.Hc.i/0/2.qdAwYFL1zc5QHdyzpXOr38RZO','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','admin@163.com','系统管理员','系统管理员','2018-10-08 13:32:47','2019-04-20 12:45:16',0,1,1,NULL),
                                                                                                                                                               (4,'macro','$2a$10$Bx4jZPR7GhEpIQfefDQtVeS58GfT5n6mxs/b4nLLK65eMFa16topa','string','macro@qq.com','macro','macro专用','2019-10-06 15:53:51','2020-02-03 14:55:55',1,1,1,NULL),
                                                                                                                                                               (6,'productAdmin','$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm',NULL,'product@qq.com','商品管理员','只有商品权限2','2020-02-07 16:15:08',NULL,1,1,1,NULL),
                                                                                                                                                               (7,'orderAdmin','$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.',NULL,'order@qq.com','订单管理员','只有订单管理权限','2020-02-07 16:15:50',NULL,1,1,1,NULL),
                                                                                                                                                               (10,'ceshi','$2a$10$RaaNo9CC0RSms8mc/gJpCuOWndDT4pHH0u5XgZdAAYFs1Uq4sOPRi',NULL,'ceshi@qq.com','ceshi',NULL,'2020-03-13 16:23:30',NULL,1,1,1,NULL),
                                                                                                                                                               (12,'rulldar','$2a$10$DGUwbXiB3InzcVwCxsZM/eg.GAMjhHmeQxmoWlE/5tz.rDb./4/3G','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','1141195251@qq.com','','','2022-09-17 19:07:53','2022-09-27 13:21:11',1,1,1,NULL),
                                                                                                                                                               (13,'rulldar1','$2a$10$TtofV3xhbibC0/aQJkNyEuS1/K7Y/O4THUPZTuukYuVG/ikDDDPdu','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','1141195251@qq.com','','','2022-09-18 16:48:37','2022-10-15 06:36:52',1,1,1,NULL),
                                                                                                                                                               (14,'rulldar12','$2a$10$eJatWrstYUI4sXO7KP21SepuIsFdpaBwCIgd/iECcEQa.3Ipv6hNG','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','1141195251@qq.com','','','2022-09-18 16:48:59','2022-09-18 17:00:11',1,1,1,NULL),
                                                                                                                                                               (40,'撒撒旦撒旦','$2a$10$qGW840n/057dJmmQPycMjOiDFBZS2VqRZ9179AT7k8srXY7j5thGa',NULL,'1141195251@qq.comsa','asd阿松大','aszxxzas','2022-09-23 11:49:07',NULL,0,1,1,NULL),
                                                                                                                                                               (41,'啊实打实的自行车自行车','$2a$10$0mXKuPjCZQijcjLdnNB8dOzwEQ.MrVpj/646qNiEJ32/u3.P0vGuC',NULL,'1141195251@qq.com','阿松大','阿松大','2022-09-23 11:49:44',NULL,1,1,1,NULL),
                                                                                                                                                               (42,'zxxzzzzzzz','$2a$10$7dxttMf7.632qvzBFMwRreqZxnvURG9lEXeD19T8RUxr4HsuREVS2',NULL,'1141195251@qq.com','asd','sadsa','2022-10-15 06:37:51',NULL,1,1,1,NULL);
...
CREATE TABLE `ums_admin_login_log` (
                                       ...
                                       PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=655 DEFAULT CHARSET=utf8 COMMENT='后台用户登录日志表';
...
insert  into `ums_admin_login_log`(`id`,`admin_id`,`create_time`,`ip`,`address`,`user_agent`) values
                                                                                                  ...
                                                                                                  (651,13,'2022-10-15 06:30:47','192.168.86.1',NULL,NULL),
                                                                                                  (652,13,'2022-10-15 06:31:49','192.168.86.1',NULL,NULL),
                                                                                                  (653,13,'2022-10-15 06:32:09','192.168.86.1',NULL,NULL),
                                                                                                  (654,13,'2022-10-15 06:36:52','192.168.86.1',NULL,NULL);
...
CREATE TABLE `ums_admin_role_relation` (
                                           ...
                                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='后台用户和角色关系表';
...
insert  into `ums_menu`(`id`,`parent_id`,`create_time`,`title`,`level`,`sort`,`name`,`icon`,`hidden`) values
                                                                                                          ...
                                                                                                          (36,32,NULL,'用户详情',2,0,'userdetails','userdetails',0),
...
insert  into `ums_resource`(`id`,`create_time`,`name`,`url`,`description`,`category_id`) values
                                                                                             ...
                                                                                             (30,'2022-10-16 18:11:57','总账管理','/ledger/**','',7),
                                                                                             (31,'2022-10-16 19:07:31','消息管理','/msm/**',' ',8),
                                                                                             (32,'2022-10-16 19:07:33','风险管理','/risk/**','',9),
                                                                                             (33,'2022-10-16 19:07:35','资金管理','/capital/**',' ',10);
...
insert  into `ums_resource_category`(`id`,`create_time`,`name`,`sort`) values
                                                                           ...
                                                                           (7,'2022-10-16 18:05:11','总账模块',0),
                                                                           (8,'2022-10-16 19:06:40','消息模块',0),
                                                                           (9,'2022-10-16 19:06:58','风险模块',0),
                                                                           (10,'2022-10-16 19:07:02','资金模块',0);
...
CREATE TABLE `ums_role_resource_relation` (
                                              ...
                                              PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=220 DEFAULT CHARSET=utf8 COMMENT='后台角色资源关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='凭证单';

/*Data for the table `voucher_item` */

insert  into `voucher_item`(`id`,`title`,`applicant`,`dept_id`,`app_date`,`total`,`status`,`comment`) values
    (1,'as',1,1,'2022-10-16 18:18:34',1.00,'1','1');
