package com.jluzh.reimbursement.generator;
...
public class MabtisPlusGenerator1 {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        return new GlobalConfig.Builder()
                .outputDir(projectPath + "/service-reimbursement/src/main/java")
                .author("banana")
                .disableOpenDir()
                .enableSwagger()
                .fileOverride()
    ...
    private static PackageConfig initPackageConfig(String projectPath, String moduleName) {
        ...
        return new PackageConfig.Builder()
                ...
                .entity("model")
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/service-reimbursement/src/main/resources/mapper/" + moduleName))
                .build();
    }
